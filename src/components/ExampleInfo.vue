...
<template>
  <div v-if="!info.hide && open" class="fixed z-50 top-4 left-4 right-4 px-6 max-w-full sm:w-96 rounded-lg font-karla text-gray-400 bg-gray-900 dark:bg-gray-100 dark:text-gray-500">
    ...
    <div class="flex items-center justify-between pb-4">
      <span class="pt-1"><a :href="info.website" class="transition-colors text-white dark:text-black hover:text-white font-extrabold tracking-tight text-xl">wordle.elementlab.net</a></span>

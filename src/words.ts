// copied from Wordle source: https://github.com/ordlek/ordlek
export const answers = [
  'abacı', 'abaka', 'abalı', 'abani', 'abaza', 'abbas', 'abdal', 'abece', 'abide', 'abiye',
  ...
  'burcu', 'burka', 'burma', 'buruk', 'burun', 'buzla', 'buğra', 'böcek', 'bölge',
  ...
  'emvat', 'enbar', 'encir', 'ender', 'enfas', 'engel', 'engin', 'enver', 'epkem',
  ...
  'sevda', 'sevgi', 'sevim', 'seçim', 'seçme', 'shona', 'sibak', 'sibel', 'sigar',
...
const allowedGuesses =[
  'ababa', 'abacı', 'abadi', 'abaju', 'abaka', 'abaks', 'abalı', 'abani', 'abant', 'abara',
  ...
  'alınç', 'alışı', 'amade', 'amana', 'amane', 'amaro', 'ambar', 'amber',  'amdan',
  'amele', 'ameli', 'amete', 'amfor', 'amidi', 'amigo', 'amino', 'amiri',  'amorf',
  'amors', 'amper', 'ampir', 'ampul', 'ampül', 'amuca', 'amuda', 'amudi',  'anaca',
  ...
  'bölme', 'bölük', 'bölüm', 'bölün', 'bölüt', 'bölüş', 'bönce', 'börek', 'börtü',
  ...
  'emvat', 'emzik', 'enayi', 'enbar', 'encam', 'endam',
  ...
  'evgin', 'evham', 'evire', 'eviri', 'eviye', 'evlat', 'evlek', 'evler', 'evlik',
  ...
  'sibob', 'sibop', 'sicil', 'sicim', 'sidik', 'sifin', 'sifon', 'sigar', 'sihir', 'sikke', 'silah', 'silaj', 'silgi', 'silik', 'silip',
  ...
  'yapık', 'yapım', 'yapıp', 'yapıt', 'yapış',  'yaran', 'yarar', 'yaraş', 'yarda',
